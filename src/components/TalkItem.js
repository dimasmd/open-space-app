...
function TalkItem({
  ...
  return (
    <div data-test="talk-item" role="button" tabIndex={0} className="talk-item" onClick={onTalkClick} onKeyDown={onTalkPress}>
      ...
      <div className="talk-item__detail">
        ...
        <article>
          <p data-cy="talk-item-text" className="talk-item__text">{text}</p>
        </article>
        {
          like && (
